...
export const IconHeart2 = ({ className }: Props): JSX.Element => {
  return (
    <svg
      className={`${className}`}
      fill="none"
    ...
    >
      <g filter="url(#filter0_b_2795_1876)">
        <g filter="url(#filter1_bd_2795_1876)">
          <path
      ...
      <defs>
        ...
        >
          ...
          <feComposite in2="SourceAlpha" operator="in" result="effect1_backgroundBlur_2795_1876" />
          <feBlend in="SourceGraphic" in2="effect1_backgroundBlur_2795_1876" mode="normal" result="shape" />
        </filter>
        <filter
          colorInterpolationFilters="sRGB"
          filterUnits="userSpaceOnUse"
          height="22.4979"
          id="filter1_bd_2795_1876"
          width="26"
          x="-1"
          y="1"
        >
          ...
          <feBlend in2="effect1_backgroundBlur_2795_1876" mode="normal" result="effect2_dropShadow_2795_1876" />
          <feBlend in="SourceGraphic" in2="effect2_dropShadow_2795_1876" mode="normal" result="shape" />
        </filter>
      </defs>
    </svg>
  );
