...
export const Six = ({ className }: Props): JSX.Element => {
  return (
    <svg
      className={`${className}`}
      fill="none"
    ...
    >
      ...
      <path
        ...
        strokeOpacity="0.5"
      />
      <mask height="32" id="mask0_2678_925" maskUnits="userSpaceOnUse" width="20" x="1" y="1">
        <path
          d="M8.7331 2.59159C9.62955 0.469472 12.3705 0.469471 13.2669 2.59159L20.1904 18.9812C22.9969 25.6248 18.1619 33 11 33C3.83812 33 -0.996889 25.6248 1.80958 18.9812L8.7331 2.59159Z"
          fill="#A9DCFF"
        />
      ...
      <g mask="url(#mask0_2678_925)">
        <rect fill="#A9DCFF" height="29.44" width="20" x="1" y="13.8" />
      </g>
    </svg>
  );
};
