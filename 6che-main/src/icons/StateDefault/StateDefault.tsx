...
export const StateDefault = ({ className }: Props): JSX.Element => {
  return (
    <svg
      className={`${className}`}
      fill="none"
    ...
    >
      ...
      <defs>
        ...
        >
          ...
          <feComposite in2="SourceAlpha" operator="in" result="effect1_backgroundBlur_2350_1040" />
          <feBlend in="SourceGraphic" in2="effect1_backgroundBlur_2350_1040" mode="normal" result="shape" />
        </filter>
      </defs>
    </svg>
  );
