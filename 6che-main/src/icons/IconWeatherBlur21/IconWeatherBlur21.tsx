...
export const IconWeatherBlur21 = ({ className }: Props): JSX.Element => {
  return (
    <svg
      className={`${className}`}
      fill="none"
    ...
    >
      ...
      <path
        ...
        fill="#B3B3B3"
      />
      <g filter="url(#filter0_bd_2795_1569)">
        <path
      ...
      <defs>
        ...
        >
          ...
          <feComposite in2="SourceAlpha" operator="in" result="effect1_backgroundBlur_2795_1569" />
          <feColorMatrix
            in="SourceAlpha"
            result="hardAlpha"
            type="matrix"
          ...
          <feBlend in2="effect1_backgroundBlur_2795_1569" mode="normal" result="effect2_dropShadow_2795_1569" />
          <feBlend in="SourceGraphic" in2="effect2_dropShadow_2795_1569" mode="normal" result="shape" />
        </filter>
      </defs>
    </svg>
  );
