...
export const IconHeart1 = ({ className }: Props): JSX.Element => {
  return (
    <svg
      className={`${className}`}
      fill="none"
    ...
    >
      <g filter="url(#filter0_bd_2772_2624)">
        <path
      ...
      <defs>
        ...
        >
          ...
          <feComposite in2="SourceAlpha" operator="in" result="effect1_backgroundBlur_2772_2624" />
          <feColorMatrix
            in="SourceAlpha"
            result="hardAlpha"
            type="matrix"
          ...
          <feBlend in2="effect1_backgroundBlur_2772_2624" mode="normal" result="effect2_dropShadow_2772_2624" />
          <feBlend in="SourceGraphic" in2="effect2_dropShadow_2772_2624" mode="normal" result="shape" />
        </filter>
      </defs>
    </svg>
  );
